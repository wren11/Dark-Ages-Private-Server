...
namespace Darkages.Types
{
    public interface ISprite
    {
        ...
        void ApplyDamage(Sprite damageDealingSprite, int dmg, bool penetrating = false, byte sound = 1, Action<int> dmgcb = null, bool forceTarget = false);
        void OnDamaged(Sprite source, int dmg);
        bool DamageTarget(Sprite damageDealingSprite, ref int dmg, bool penetrating, byte sound, Action<int> dmgcb, bool forced);
