...
{
    public class Session<T> where T : NetworkClient
    {
        ...
        public Session(T client, NetworkSocket clientSocket, int capacity = ushort.MaxValue)
        {
            _client = client;
        ...
        public bool IsConnected => _client?.Session.ConnectedSocket?.Connected ?? false;
        public int OptionSendBufferSize { get; set; }
        public Socket Socket => _client.Session?.ConnectedSocket;
