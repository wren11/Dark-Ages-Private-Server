...
namespace Darkages.Systems.CLI
{
    public class Commander
    {
        ...
        private static void OnPet(Argument[] args, object arg)
        {
            ...
            client.Aisling.SummonObjects.Spawn("Minion", "Common Pet", 2000, 500, 50);
        }
        ...
        private static void OnTeleport(Argument[] args, object arg)
        {
            ...
            if (client != null)
            {
                ...
                var area = ServerContext.GlobalMapCache.FirstOrDefault(i => i.Value.Name == mapName);
        ...
        public static void OnParseError(object obj, string command) =>
            ServerContext.Logger($"[Chat Parser] Error: {command}");
    }
}
