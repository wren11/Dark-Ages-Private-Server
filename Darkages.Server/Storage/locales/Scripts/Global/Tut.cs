            ...
            reactor = new Reactor
            {
                ...
                Sequences = new List<DialogSequence>
                {
                    new DialogSequence
                    {
                        ...
                        DisplayImage = 0x0000,
                        DisplayText =
                            "Welcome to Dark Ages : Online Roleplaying. This tutorial will give yuou the facts and skills you need to begin.",
                        Title = ""
                    },
                    new DialogSequence
                    {
                    ...
                    new DialogSequence
                    {
                        ...
                        DisplayImage = 0x0000,
                        DisplayText =
                            "The first thing you should do in this tutorial is talk to all the Merchants, There are five of them. When you are ready to leave, You can leave the tutorial by continuing to the end of this path.",
                        Title = ""
                    },
                    new DialogSequence
                    {
                        ...
                        DisplayImage = 0x0000,
                        DisplayText =
                            "to move, right click the mouse to the position of where you want to move. in tight spots, you can use the arrow keys on your keyboard. Talk to the knightnexttothe tree by double-clicking him, if you get lost, press <Tab>.",
                        Title = ""
                    },
                    new DialogSequence
                    {
                        ...
                        DisplayImage = 0x0000,
                        DisplayText =
                            "You should have a piece of clothing in your inventory. Press the <a> key to access your inventory. Double click on the piece of clothing to wear it.",
                        Title = ""
                    },
                    new DialogSequence
                    {
                        ...
                        DisplayImage = 0x0000,
                        DisplayText =
                            "You may skip this tutorial by going up this path and then turn right at the next path.",
                        Title = ""
                    }
                },
                Quest = new Quest
